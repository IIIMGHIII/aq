...
bot = Bot("gubeeknnorsmmsnfwzdgibxhmpqoceuz")
target = "g0BTm8F0d782ed7c28e7164eff6c6fd1"
			...
			try:
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					if not sleeped:
						...
						if msg.get("text") == "awsedrftgyhu!@" and msg.get("author_object_guid") in admins :
							sleeped = False
					...
					elif data["type"]=="qawzxecrtvybunimo,p.;['/'/'":
						user = bot.getUserInfo(data['peer_objects'][0]['object_guid'])["data"]["user"]["first_name"]
